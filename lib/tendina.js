...
(function() {
  ...
  (function($, window) {
    ...
    Tendina = (function() {
      ...
      Tendina.prototype._openActiveMenu = function(selector) {
        var $activeMenu, $closestParent;
        $activeMenu = this.$el.find(selector);
        ...
        return $activeMenu.parent().addClass('selected');
      };
