  ...
  (function($, window) {
    ...
    Tendina = (function() {
      ...
      function Tendina(el, options) {
        ...
        this._bindEvents();
        if (this.options.defaultMenu !== null) {
          this._openDefaultMenu(this.options.defaultMenu);
        }
      }
      ...
      Tendina.prototype._openDefaultMenu = function(selector) {
        var closestParent, defaultMenu;
        defaultMenu = this.$el.find(selector);
        closestParent = defaultMenu.closest('ul');
        if (this._hasChildenAndIsHidden(closestParent)) {
          return console.log(closestParent);
        }
      };
